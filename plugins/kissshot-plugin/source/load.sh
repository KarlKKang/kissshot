...
ln -s "/usr/local/emhttp/plugins/${plugin_name}/sbin/ddns" /usr/local/sbin/kissshot-ddns
...
ln -s "/usr/local/emhttp/plugins/${plugin_name}/sbin/xrayd" /usr/local/sbin/xrayd
